        ...
        <div class="flex items-center justify-center w-full pt-8">
            <div class="flex items-center justify-center">
                <img src="{{ asset('foto_profile/' . auth()->user()->picture) }}" width="90" height="90"
                    viewBox="0 0 70 70"fill="none" class="rounded-full ">

            </div>
        </div>
        <div class="flex flex-col mt-2">
            <div class="flex-row">
                <p class="text-2xl text-center text-black font-inika">{{ auth()->user()->username }}</p>
                <p class="text-sm text-center text-black">
                    {{ auth()->user()->bio }}
                </p>
            </div>
            <div class="flex mt-8 gap-2 justify-center ml-14">
                <button type="submit" class="bg-red-600 text-white rounded-md px-4 py-2"><a href="/edit_profile"> Edit
                        Profile</button></a>
                <button type="submit" class="bg-red-600 text-white rounded-md px-4 py-2"><a href="/album">
                        Album</button></a>
    ...
    <section class="mt-8 mb-8">
        <div class="flex max-w-screen-xl mx-auto flex-wrap justify-center ml-[40px]">
            <div class="flex flex-col">
                <div class="flex max-w-screen-md mx-auto flex-wrap gap-4">
