...
const tampilkankomentar = ()=>{
    ...
    comment.map((x, i)=>{
        $('#listkomentar').append(`
            <div class="flex flex-row justify-start mt-4 gap-2">
                <div class="w-1/4">
                    <img src="/foto_profile/${x.potopengirim}" class="w-8 h-auto rounded rounded-full" alt="">
                </div>
                <div class="flex flex-col mr-2">
                    <h5 class="text-sm font-bold mr-2">${x.pengirim}</h5>
